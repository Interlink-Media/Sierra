...
public interface EventBus {
     ...
     */
    <T extends AbstractEvent> void subscribe(Class<T> eventType, Consumer<T> event);
     ...
     */
    <T extends AbstractEvent> void subscribe(Class<T> eventType, Consumer<T> event, ListenerPriority priority);

    /**
     * Publishes an event to the event bus.
     *
     * @param <T>    the type of the event to be published, must extend {@link AbstractEvent}
     ...
     */
    <T extends AbstractEvent> void dispatchEventToSubscribers(T event,
